...
const Transform = () => {
    return (
        <div className='manrope-font mx-auto container py-30 bg-linear-to-r from-[#4F39F6] via-[#801FF9] to-[#9514FA]'>
            <div className='flex flex-col items-center justify-center gap-5'>
                <h1 className='text-[40px] text-white font-bold'>Ready to Transform Your Workflow?</h1>
