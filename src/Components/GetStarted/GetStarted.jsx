...
const GetStarted = () => {
    return (
        <div className='container mx-auto manrope-font bg-[#F9FAFC] flex flex-col items-center justify-center py-30'>

            <h1 className='font-bold text-4xl mb-4'>Get Started in 3 Steps</h1>
            <p className='text-secondary'>Start Using premium digital tolls in minutes not hours</p>
